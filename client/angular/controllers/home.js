myApp.controller('homeCtrl', ['$http', '$window','$location','$routeParams', 'testService', 'authService', function ($http,$window, $location,$routeParams, testService, authService) {
